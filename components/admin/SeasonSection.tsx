...
import { AlertTriangle, Calendar, Loader2, Pencil, Trash2, Webhook } from "lucide-react";
import {
  createSeason,
  deleteSeason,
  updateSeasonName,
  ...
  return (
    <section className="space-y-4">
      ...
      <p className="rounded-xl border border-slate-700/50 bg-slate-900/40 px-4 py-3 text-xs text-slate-400">
        ...
        The FA Ranking i FA Cup (webhooki globalne) ustawiasz w{" "}
        <Link href="/admin/webhooks" className="font-semibold text-[#39FF14] hover:underline">
          Webhooki Discord
        </Link>
        . Nie znikają po Hard Reset.
      </p>
    </section>
  );
}
