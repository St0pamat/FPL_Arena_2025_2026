...
type CrestSize = keyof typeof CREST_SIZES;
...
export const TeamCrest = ({
  ...
  if (!fplId) {
    return (
      <div
        className={`${s.box} rounded-lg border-2 border-dashed border-slate-600 shrink-0 ${className}`}
      />
    );
  }
...
export const LeagueLogo = ({ size = "md", className = "" }: LeagueLogoProps) => {
